...
# source: github_com/grpc-ecosystem/grpc-gateway/third_party/googleapis/google/api/http.proto
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'github_com.grpc_ecosystem.grpc_gateway.third_party.googleapis.google.api.http_pb2'
